...
# ASR model related
tag=
asr_tag=wavlm_libri100_singleview        # Suffix to the result dir for asr model training.
asr_exp=        # Specify the directory path for ASR experiment.
                # If this option is specified, asr_tag is ignored.
asr_stats_dir=exp/asr_stats_wavlm_libri100_singleview  # Specify the directory path for ASR statistics.
...
view=singleView #singleView" or "multiView" for k-means (Multiview supports wavlm and hubert)
